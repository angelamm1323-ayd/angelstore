    ...
    <div class="max-w-6xl mx-auto space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            {#each [{ label: "Total Ingresos", value: totalIngresos, color: "text-green-400" }, { label: "Total Gastos", value: totalGastos, color: "text-red-400" }, { label: "Balance", value: balance, color: balance >= 0 ? "text-green-400" : "text-red-400" }] as card}
                <div
                    class="bg-white p-4 rounded-lg border border-pink-200 shadow-sm"
                >
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <!-- Form -->
            <section class="bg-pink-50 p-2 rounded border border-pink-100">
                ...
                <form on:submit|preventDefault={handleSave} class="space-y-4">
                            ...
                            {#each tipos as t}
                                <label class="flex items-center cursor-pointer">
                                    <input
                                        ...
                                        class="h-4 w-4 text-pink-600 focus:ring-pink-500 border-pink-600"
                                    />
                                    <span class="ml-2 text-sm text-pink-900"
                                        >{t.label}</span
                                    >
                                </label>
                            {/each}
                    ...
                    {#if isVenta}
                        ...
                        <div>
                            ...
                            <select
                                ...
                                class="w-full px-3 py-2 rounded bg-white text-pink-900 border border-pink-200"
                                required
                            >
                            ...
                            <div class="space-y-3">
                                <div class="flex items-end gap-2">
                                    ...
                                    <button
                                        ...
                                        class="px-3 py-2 bg-pink-500 hover:bg-pink-600 text-white rounded disabled:opacity-50 disabled:cursor-not-allowed"
                                ...
                                {#if tallasVendidas.length > 0}
                                    <div
                                        class="border border-pink-200 rounded p-3 bg-white"
                                    >
                                        <h4
                                            class="text-sm font-medium text-pink-900 mb-2"
                                        >
                                            Tallas a vender:
                                        </h4>
                                        <ul class="space-y-2">
                                            {#each tallasVendidas as item, i}
                                                <li
                                                    class="flex justify-between items-center text-sm bg-pink-100 p-2 rounded"
                                                >
                                                    <span class="text-pink-900">
                                                        ...
                                                        x {item.cantidad}
                                                        <span
                                                            class="text-pink-500 text-sm block"
                                                        >
                                                    ...
                                                    >
                                                        <span
                                                            class="font-medium text-pink-900"
                                                        >
                                                            ${(
                                                                item.cantidad *
                                                                item.precioUnitario
                                            ...
                                            {/each}
                                            <li
                                                class="pt-2 mt-2 border-t border-pink-200 font-medium flex justify-between items-center"
                                            >
                                                <span class="text-pink-700"
                                                    >Total:</span
                                                >
                                                <span
                                                    class="text-xl text-pink-900"
                                                >
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    class="w-full pl-8 pr-3 py-2 rounded bg-white text-pink-900 border border-pink-200 focus:ring-2 focus:ring-pink-500"
                                    placeholder="0"
                                    required
                                />
                            </div>
                    ...
                    <div class="flex gap-2 pt-2">
                        <button
                            type="submit"
                            class="flex-1 bg-pink-600 hover:bg-pink-700 text-white py-2 px-4 rounded flex items-center justify-center gap-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        ...
                        {#if editingDocId}
                            <button
                                type="button"
                                on:click={clearForm}
                                class="bg-pink-200 hover:bg-pink-300 text-pink-800 py-2 px-4 rounded flex items-center justify-center gap-2 transition-colors"
                            >
            ...
            <section class="lg:col-span-2">
                ...
                {#if accounts.length === 0}
                    ...
                    >
                        <i class="fas fa-receipt text-4xl text-pink-300 mb-2"
                        ></i>
